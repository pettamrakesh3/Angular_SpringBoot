...
public class JWTUtils {
    ...
    private String createToken(Map<String, Object> claims, String subject) {
        return Jwts.builder()
                ...
                .setExpiration(new Date(System.currentTimeMillis() + 1000 * 60 * 24)) // Token valid for 10 hours
    ...
    private String generateRefreshToken(Map<String, Object> claims, String subject) {
        return Jwts.builder()
                ...
                .setSubject(subject)
                .setIssuedAt(new Date(System.currentTimeMillis()))
                .setExpiration(new Date(System.currentTimeMillis() + 604800000)) // Token valid for 10 hours
                .signWith(getSigningKey(),SignatureAlgorithm.HS256)
                .compact();
    }
